# Prompt para Resumir Transcripción de YouTube
...
A continuación, te proporciono la transcripción de un video. Analízala en profundidad y genera un resumen ejecutivo que capture la esencia del contenido de manera concisa y contundente.

## Instrucciones Específicas:

- Tono y Estilo: Utiliza un lenguaje claro, directo y atractivo. Evita la jerga innecesaria y las frases redundantes.

- Público Objetivo: El resumen está destinado a lectores con poco tiempo (ejecutivos, estudiantes, curiosos) que necesitan captar las ideas principales rápidamente.

- Extensión: El resumen final debe ser conciso, idealmente entre 200 y 400 palabras.
...
Sintetiza la tesis o mensaje central del creador en un solo párrafo poderoso.
...
Sé contundente. Cada punto debe ser una idea autónoma y valiosa.
